                        ...
                        <div class="col-lg-12">
                            <div class="coupon_toggle">
                                <div class="coupon_code">
                                   Bienvenue sur <a href="checkout.html">E-medical</a> <p class="payment_policy" style="text-align:center !important">Quel type de rendez-vous avez-vous besoin ? </p>
                                </div>
                            </div>

                            <form name="checkout" method="post" class="checkout row" action="index1.php">
                                <div class="col-lg-6">
                                   <center><a href="choixmedecin01.php"><img id="logo-img" width="50%" class="img-center" src="images/typerendezvous.png" alt="logo"><br> Présentiel
                                 ...
                                 <div class="col-lg-6">
                                   <center> <a href="choixmedecin02.php"> <img id="logo-img" width="50%" class="img-center" src="images/typerendezvous02.png" alt="logo"><br> Visioconférence</a></center> 
