                        ...
                        <div class="col-lg-12">
                            <div class="coupon_toggle">
                                <div class="coupon_code">
                                   Bienvenue sur <a href="checkout.html">E-medical</a> <p class="payment_policy" style="text-align:center !important">Quel type de compte avez-vous besoin ? </p>
                                </div>
                            </div>

                            <form name="checkout" method="post" class="checkout row" action="index1.php">
                                <div class="col-lg-6">
                                   <center><a href="inscription.php"><img id="logo-img" width="50%" class="img-center" src="images/patient.png" alt="logo"><br> Simple utilisateur
                                 ...
                                 <div class="col-lg-6">
                                   <center> <a href="inscription01.php"> <img id="logo-img" width="50%" class="img-center" src="images/medecin.png" alt="logo"><br> Personnel de santé</a></center> 
