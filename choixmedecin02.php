                    ...
                    <div class="ttm-topbar-content">
                        ...
                        <div class="topbar-right text-right">
                            ...
                            <div class="header-btn">
                                <a class="ttm-btn ttm-btn-size-md  ttm-btn-bgcolor-info" href="index.php">Deconnexion</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="coupon_toggle">
                                <div class="coupon_code">
                                   Bienvenue sur <a href="checkout.html">E-medical</a> <p class="payment_policy" style="text-align:center !important">Vous avez choit le rendez-vous en visoconférence</p>
                                </div>
                            </div>

                            <form name="checkout" method="post" class="checkout row" action="disponibilite.php">
                                <div class="col-lg-6">
                                  <center> <a href="inscription01.php"> <img id="logo-img" width="50%" class="img-center" src="images/typerendezvous02.png" alt="logo"></a></center> 
                                   ...
                                   <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Choix medecin<abbr>*</abbr></label>
                                                <select class="form-control border">
                                                    
                                                    <option>
                                                        Dr.  SAFOU Poupouche / Dentiste
                                                    </option>
                                                    
                                                    <option>
                                                        Dr. Dimitri / Ophtamologue
                                                    </option>
                                                    <option>
                                                         Dr.SAMUEL / Cardiologue
                                                    </option>
                                                    <option>
                                                           Dr.Grace / Cardiologue
                                                    </option>
                                                    <option>
                                                            Dr.Sarah
                                                    </option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                 <label>Motif<abbr>*</abbr></label>
                                                <input type="text" name="fname" class="form-control border">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                 <label>Date<abbr>*</abbr></label>
                                                <input type="date" name="fname" class="form-control border">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Heure :<abbr>*</abbr></label>
                                                <input type="time" name="lname" class="form-control border">
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-sm-12">
                                            <button type="submit" class="button ttm-btn ttm-btn-size-sm ttm-btn-bgcolor-darkgrey pull-center" name="checkout_place_order" id="place_order" value="Place order" data-value="Place order">Disponibilité</button>
                                        </div>
