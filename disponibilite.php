                        ...
                        <div class="col-lg-12">
                            <div class="coupon_toggle">
                                <div class="coupon_code">
                                   Bienvenue sur <a href="checkout.html">E-medical</a><center> <p class="payment_policy" style="text-align:center,color:green !important"> <strong> Félicitation, le Dr SAFOU est bien disponible pour votre rendez-vous.</strong> <br>du <strong>26 octobre 2020 à 8h00 <br>
                                    <h1> il vous reste à payer les frais de consultation ! 
                                    <br> <span style="color:red">18 000 Fcfa</span>  </h1>
                                    </strong> </center>
                            ...
                            <form name="checkout" method="post" class="checkout row" action="index1.php">
                                <div class="col-lg-4">
                                  <center> <a href="confirmation.php"> <img id="logo-img" width="50%" class="img-center" src="images/payement3.png" alt="logo"></a>
                                  </center> 

                                   
                                </div>
                                <div class="col-lg-4">
                                  <center> <a href="confirmation.php"> <img id="logo-img" width="50%" class="img-center" src="images/payement1.png" alt="logo"></a>
                                  </center> 

                                   
                                </div>
                                <div class="col-lg-4">
                                  <center> <a href="confirmation.php"> <img id="logo-img" width="50%" class="img-center" src="images/payement2.png" alt="logo"></a>
                                  </center> 
