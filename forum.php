                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                   ...
                                   <ul>
                                            <li><a href="detailquestion.php">Comment faire dégonfler un abcès dentaire ?</a></li> <br>
                                            <li><a href="#">
                                                Comment Degonfler une joue gonflée ?</a>
                                            </li> 
                                            <br>
                                            <li><a href="#">
                                            ...
                                            <li><a href="#">Comment faire dégonfler un abcès dentaire ?</a></li> <br>
                                            <li><a href="#">
                                                Comment Degonfler une joue gonflée ?</a>
                                            </li> 
                                            <br>
                                ...
                                <div class="col-lg-6">
                                    <h4> Posez une nouvelle question </h4>
                                     <div class="form-group">
                                                <label>Intitulé de la question<abbr>*</abbr></label>
                                                <input type="text" name="fname" class="form-control border">
                                            </div>
                                     <div class="form-group">
                                                <label>Details<abbr>*</abbr></label>
                                                <textarea class="form-control border">

                                                </textarea>
                                            </div>

                                    <form name="checkout" method="post" class="checkout row" action="validationquestion.php">


                                             <button type="submit" class="button ttm-btn ttm-btn-size-sm ttm-btn-bgcolor-darkgrey pull-center" name="checkout_place_order" id="place_order" value="Place order" data-value="Place order">Valider</button>
