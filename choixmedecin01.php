                        ...
                        <div class="col-lg-12">
                            <div class="coupon_toggle">
                                <div class="coupon_code">
                                   Bienvenue sur <a href="checkout.html">E-medical</a> <p class="payment_policy" style="text-align:center !important">Vous avez choit le rendez-vous en Présentiel</p>
                                </div>
                            </div>

                            <form name="checkout" method="post" class="checkout row" action="disponibilite.php">
                                <div class="col-lg-6">
                                   <center><a href="inscription.php"><img id="logo-img" width="50%" class="img-center" src="images/typerendezvous.png" alt="logo">
