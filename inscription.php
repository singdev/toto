                        ...
                        <div class="col-lg-12">
                            <div class="coupon_toggle">
                                <div class="coupon_code">
                                   Information<a href="checkout.html">Personnelle</a> 
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                 <label>Nom(s) et prénom(s)<abbr>*</abbr></label>
                                                <input type="text" name="fname" class="form-control border">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Date de naissance<abbr>*</abbr></label>
                                                <input type="date" name="lname" class="form-control border">
                                            </div>
                                        </div>

                                         <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Type d'assurance<abbr>*</abbr></label>
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                         ...
                                         <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Numéro de sécurité sociale<abbr>*</abbr></label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Confirmation mot de passe<abbr>*</abbr></label>
                                                <input type="password" name="lname" class="form-control border">
                                            </div>
                                        </div>
