            ...
            <div class="ttm-row only-one-section ttm-bgcolor-white clearfix">
                <div class="container">
                     <div class="coupon_code">
                                    <p class="payment_policy" style="text-align:center !important"> </p>
                                </div>
                    <!-- row -->
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                   <h4> Consultez les anciennes questions ! </h4>
                                   <ul>
                                            <li><a href="#">Comment faire dégonfler un abcès dentaire ?</a></li> 
                                            <li><a href="#">
                                                Comment faire dégonfler un abcès dentaire ? ?</a>
                                            </li>
                                ...
                                <div class="col-lg-6">
                                    <h5> Comment faire dégonfler un abcès dentaire ? </h5>
                                     
                                     <p style="text-align:center">
                                         
Si vous souffrez d’un abcès dentaire, peu importe sa localisation dans votre bouche et le degré d’intensité de vos douleurs, vous devez prendre rendez vous chez votre dentiste à Paris ou un médecin dans les plus brefs délais.
                                     <br>
                                     ...
                                     DR.SAFOU POUPOUCHE / Dentiste  CHUL
                                     <p>
                                         <i>
                                             Utiliser un bain de bouche.
Appliquer un gel anesthésiant.
Faire un bain de bouche à base d'huiles essentielles. ...
Faire un bain de bouche à base de bicarbonate de soude. ...
Placer un clou de girofle entre la gencive et la joue et le garder ainsi quelques instants.
                                         </i>
                                     </p>
                                     ...
                                     DR.CHARLES / Dentiste CHU OWENDO
                                     <p>
                                         <i>
                                             Utiliser un bain de bouche.
Appliquer un gel anesthésiant.
